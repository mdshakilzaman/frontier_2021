...
class GaussianProcessRegressor(BaseEstimator, RegressorMixin):
    ...
    """
    def __init__(self, kernel=None, alpha=1e-10, hyp_opt_max_iter=1,
        ...
        self.hyp_opt_max_iter=hyp_opt_max_iter
    ...
    def fit(self, X, y):
        ...
        if self.optimizer is not None and self.kernel_.n_dims > 0:# and len(y)%self.hyp_opt_max_iter==0:
#            t0=time.time()
...
#            t1=time.time()
#            print('time for maximizing log-marginal lik for hyper parameter maximization ' + str(t1-t0))
        else:
...
#        t1=time.time()
#        print('time to get K matrix : ' + str(t1-t0))
...
#        t0=time.time()
        ...
        return self
#        t1=time.time()
#        print('time to get alpha (invert K) : ' + str(t1-t0))
